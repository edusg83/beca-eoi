...
// Invocamos sus funciones para imprimir los datos por consola
hijo1.muestraDatos();
hijo2.muestraDatos();
...
// Imprimimos por consola la edad de cada hijo con sus nuevas funciones heredadas
hijo1.verEdad();
hijo2.verEdad();