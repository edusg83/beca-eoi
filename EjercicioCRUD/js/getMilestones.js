    ...
    respuestaMilestones.data.forEach(item => {
        ...
        <tr class="bg-dark text-white rounded-bottom">
            ...
            <td class="col-sm-2 p-2 mb-2 border border-2 border-danger">
                <button data-bs-toggle='modal' data-bs-target='#modalDeleteMilestone' onclick="eliminarMilestone(${item.id})">
...
function eliminarMilestone(idItemEliminar) {
    axios.delete(urlMilestones + "/" + idItemEliminar, { headers })
        .then((respuesta) => {
