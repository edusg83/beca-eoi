...
function editarObjeto(idItem) {
    axios.get(urlGoals+"/"+idItem,{headers})
    .then((respuestaProductos) => {

        document.getElementById("nameModal").value = respuestaProductos.data.name;
        document.getElementById("descriptionModal").value = respuestaProductos.data.description;
        document.getElementById("progressModal").value = respuestaProductos.data.progress;
        document.getElementById("assignedToModal").value = respuestaProductos.data.assignedTo;
        
        // Formulario para modificar articulos
        const form = document.getElementById('modificacionModal');
        form.addEventListener('submit', function(element) {
            ...
            const dataRequest = {
                ...
                "progress":document.getElementById("progressModal").value,
                "assignedTo":document.getElementById("assignedToModal").value
            };
            axios.put(urlGoals+"/"+idItem,dataRequest,{headers})
            .then((url) => {
...
function guardaIdEliminar(idItem, nombreProducto){
    ...
    console.log(idItem + " / " +  nombreProducto);
    document.getElementById("nombreProducto").innerHTML=nombreProducto;
}

function eliminarObjeto(){
    axios.delete(urlGoals+"/"+idItemEliminar,{headers})
    .then((respuesta) => {
